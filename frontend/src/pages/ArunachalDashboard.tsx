...
export function ArunachalDashboard({ onBack }: ArunachalDashboardProps) {
  ...
  const [prediction, setPrediction] = useState<ArunachalPredictionResponse | null>(null);
  ...
  useEffect(() => {
    ...
    // Real per-cell prediction: the persisted Arunachal model over the AOI grid with real
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7">
            ...
            {/* Predicted risk zones — the persisted Arunachal model over the AOI grid with
            ...
            <div className="mt-4 space-y-3">
              {predictionState === 'loading' && (
                <div className="flex items-center gap-2 rounded-lg border border-slate-800 bg-slate-900/40 p-3 font-mono text-[11px] text-slate-400">
                  ...
                  Running the Arunachal model over the AOI grid with real land cover and IMERG antecedent rainfall…
                </div>
              )}
