/**
 * Assam validated-pilot console.
 *
 * Every figure on this page is fetched live from the persisted Assam evidence
 * bundle (GET /api/v1/validation/assam/evidence), the real GLC positives
 * (GET /api/v1/validation/assam/events), and a live per-cell prediction
 * (GET /api/v1/predict/assam/grid). Nothing is fabricated:
...
function ModelComparisonTable({
  ...
  comparison: AssamEvidenceResponse['metrics'] extends null
    ? never
    : NonNullable<AssamEvidenceResponse['metrics']>['model_comparison'];
}) {
...
function ProvenancePanel({
  ...
  provenance: AssamEvidenceResponse['provenance'];
}) {
  if (!provenance) {
    return (
      <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-5 text-[13px] text-slate-400">
    ...
    <div className="grid gap-4 lg:grid-cols-2">
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-5">
        ...
        <p className="mt-2 text-[10px] leading-relaxed text-slate-500">
          Mirrors the backend provenance artifact verbatim. The Assam model was trained on
    ...
    <div className="min-h-screen bg-[#0a0d12] text-slate-100">
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-3">
              <Eyebrow>Assam · Guwahati-Kamrup pilot</Eyebrow>
              {evidenceState === 'ready' && (
            ...
            <h1 className="mt-2 text-2xl font-bold tracking-tight text-slate-50 sm:text-3xl">
              Assam landslide susceptibility console
            </h1>
        ...
        {evidenceState === 'error' && (
          <div className="mt-5 flex items-start gap-3 rounded-xl border border-amber-500/25 bg-amber-500/[0.05] p-4">
            ...
            <div className="text-[13px] leading-relaxed text-slate-300">
              ...
              <code className="font-mono text-slate-400">/api/v1/validation/assam/evidence</code>{' '}
