/**
 * Sikkim pilot map — the exact modelled AOI rectangle, the real NASA GLC
 * landslide positives inside it, and (when available) the model's predicted
 * per-grid-cell susceptibility zones. Event points and predicted cells are both
 * supplied by the parent; this component invents nothing. Points are coloured only
 * by their honest spatial-uncertainty class (precise <5 km vs approximate ≥5 km);
